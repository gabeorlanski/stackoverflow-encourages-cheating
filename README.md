...
2. To run the model, run the [`experiment.py`]() script. You can use `python experiment.py -h` or 
...
the [html tags file]() to remove them. Note, you must surround the tag text with `< >`.    
